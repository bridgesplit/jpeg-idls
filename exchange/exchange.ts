export type Exchange = {
    ...
    instructions: [
        ...
        {
            name: "initWallet";
            docs: ["initializer a new bidding wallet"];
            accounts: [
                {
                    name: "initializer";
                    isMut: true;
    ...
    accounts: [
        {
            ...
            type: {
                ...
                fields: [
                    {
                        name: "version";
                        docs: ["market account version"];
                        type: "u8";
                    },
                    {
                        name: "poolMint";
                        docs: ["mint of the index to which the NFTs belong to"];
                        type: "publicKey";
                    },
                    {
                        name: "initializer";
                        docs: ["initializer of the market - can edit and close the market"];
                        type: "publicKey";
                    },
                    {
                        name: "state";
        ...
        },
        {
            ...
            type: {
                ...
                fields: [
                    ...
                    {
                        name: "wallet";
                        docs: ["bidding wallet of the owner"];
                        type: "publicKey";
                    },
                    {
                        name: "side";
        ...
        {
            name: "wallet";
            docs: ["wallet account - bidding authority and funds holder"];
            type: {
                kind: "struct";
                fields: [
                    {
